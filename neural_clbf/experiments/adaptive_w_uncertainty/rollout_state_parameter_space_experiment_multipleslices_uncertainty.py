"""
rollout_state_parameter_space_experiment_multiple_slices_uncertainty
Description
...
class RolloutStateParameterSpaceExperimentMultipleUncertainty(Experiment):
    ...
    def __init__(
        ...
        """
        super(RolloutStateParameterSpaceExperimentMultipleUncertainty, self).__init__(name)
    ...
    def run(self, controller_under_test: "Controller") -> pd.DataFrame:
        ...
        # Constants
        n_sims = self.n_sims_per_start * self.start_x.shape[0] # Compute the number of simulations to run
        ...
        theta_err_hat_sim_start = torch.zeros(n_sims, n_theta).type_as(theta_sim_start)
        theta_err_hat_sim_start[:, :] = controller_under_test.dynamics_model.Theta.chebR * 1.0
        ...
        theta_err_hat_current = theta_err_hat_sim_start.to(device)
        ...
        for tstep in prog_bar_range:
            ...
            if tstep % controller_update_freq == 0:
                ...
                u_current, r_current = controller_under_test.solve_CLF_QP(
            ...
            for sim_index in range(n_sims):
                ...
                log_packet["theta_err_hat"] = theta_err_hat_current[sim_index, :].cpu().detach().numpy()
            ...
            for i in range(n_sims):
                theta_hat_dot = controller_under_test.closed_loop_estimator_dynamics(
                    ...
                    theta_err_hat_current[sim_index, :].unsqueeze(0),
