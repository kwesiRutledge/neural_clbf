...
class CaseStudySafetyExperiment(Experiment):
    ...
    def run_aclbf_controlled(self, controller_under_test: "Controller") -> pd.DataFrame:
        ...
        scen_sim_start = self.start_scen.clone()
        ...
        scen_current = scen_sim_start.to(device)
        ...
        for tstep in prog_bar_range:
            ...
            if tstep % controller_update_freq == 0:
                ...
                u_current = controller_under_test.u(
                    x_current, theta_hat_current, scen_current,
            ...
            if hasattr(controller_under_test, "V") and h is None:
                V = controller_under_test.V(x_current, theta_hat_current, scen_current)  # type: ignore
            ...
            for sim_index in range(n_sims):
                ...
                log_packet["scen"] = scen_current.clone()[sim_index, :].cpu().numpy()
