"""
eval_pusher_slider_sticking_force_input.py
Description:
    Evaluates the pusher slider system.

    TODO: Complete this funciton. I only recently copied its contents into this file.
"""
...
if __name__ == "__main__":
    ...
    parser = ArgumentParser(
        description="This script evaluates a trained aCLBF controller for the AdaptivePusherSliderStickingForceInput_CustomGoal system.",
    )
    parser.add_argument(
