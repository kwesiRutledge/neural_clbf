...
from neural_clbf.systems.adaptive_w_scenarios import (
    AdaptivePusherSliderStickingForceInput3, ControlAffineParameterAffineSystem3,
)
from neural_clbf.systems.adaptive_w_scenarios import AdaptivePusherSliderStickingForceInput3 as apssfi
...
class TestNeuralACLBFv5(unittest.TestCase):
    ...
    def get_ps_with_neuralaclbfcontroller1(self) -> (ControlAffineParameterAffineSystem3, NeuralaCLBFControllerV6):
        """
        ...
        controller = NeuralaCLBFControllerV6(
            sys0,
            datamodule,
            experiment_suite,
    ...
    def test_simulate1(self):
        ...
        # Algorithm
        x_sim, theta_sim, theta_hat_sim, scen_sim = controller.simulate(
            x, theta, scen, 10,
            controller.u,
        )
