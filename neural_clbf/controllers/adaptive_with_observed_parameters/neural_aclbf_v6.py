...
from neural_clbf.controllers.adaptive_with_observed_parameters.adaptive_control_utils2 import (
    center_and_radius_to_vertices, violation_weighting_function2,
    normalize_theta_with_angles, normalize_scenario_with_angles,
)
...
class NeuralaCLBFControllerV6(aCLFController6, pl.LightningModule):
    """
    ...
    def __init__(
        self,
        dynamics_model: ControlAffineParameterAffineSystem3,
        ...
        """
        super(NeuralaCLBFControllerV6, self).__init__(
            dynamics_model,
            experiment_suite,
