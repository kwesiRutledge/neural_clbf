"""
test_hybrid_clf_controller1.py
Description:
    Test the the vanilla clbf controller for the HybridControlAffineSystem.
"""
import torch
import random
...
from neural_clbf.controllers.hybrid_clf_controller1 import (
    HybridCLFController1,
)
...
def test_init_hybridclfcontroller1():
    """
    Description:
        Test the initialization of a HybridCLFController
    """
    ...
    system = PusherSlider(scenario)

    experiment_suite = ExperimentSuite([])

    # Instantiate with a list of only one scenarios
    scenarios = [scenario]
    controller = HybridCLFController1(system, scenarios, experiment_suite)
