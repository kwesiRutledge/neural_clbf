...
class AdaptivePusherSliderStickingForceInput3(ControlAffineParameterAffineSystem3):
    """
    ...
    def __init__(
        ...
        if V_scenario is None:
            ...
            for i in range(self.n_obstacles):
                box_limits += [
                    (x_lb[AdaptivePusherSliderStickingForceInput3.S_X], x_ub[AdaptivePusherSliderStickingForceInput3.S_X]),
                    (x_lb[AdaptivePusherSliderStickingForceInput3.S_Y], x_ub[AdaptivePusherSliderStickingForceInput3.S_Y]),
                    # (0.0, 0.1),
                ]
    ...
    @property
    def n_dims(self) -> int:
        return AdaptivePusherSliderStickingForceInput3.N_DIMS

    @property
    def angle_dims(self) -> List[int]:
        return [AdaptivePusherSliderStickingForceInput3.S_THETA]
    ...
    def n_controls(self) -> int:
        return AdaptivePusherSliderStickingForceInput3.N_CONTROLS

    @property
    def n_params(self) -> int:
        return AdaptivePusherSliderStickingForceInput3.N_PARAMETERS

    @property
    def n_scenario(self) -> int:
        return self.n_obstacles * 2 + 2
    ...
    def state_limits(self) -> Tuple[torch.Tensor, torch.Tensor]:
        ...
        upper_limit[AdaptivePusherSliderStickingForceInput3.S_X] = 1.0
        upper_limit[AdaptivePusherSliderStickingForceInput3.S_Y] = 1.0
        upper_limit[AdaptivePusherSliderStickingForceInput3.S_THETA] = torch.pi
    ...
    def goal_point(self, theta: torch.Tensor, s_vec: torch.Tensor) -> torch.Tensor:
        ...
        goal[:, AdaptivePusherSliderStickingForceInput3.S_X] = s_vec[:, AdaptivePusherSliderStickingForceInput3.GOAL_X]
        goal[:, AdaptivePusherSliderStickingForceInput3.S_Y] = s_vec[:, AdaptivePusherSliderStickingForceInput3.GOAL_Y]
        goal[:, AdaptivePusherSliderStickingForceInput3.S_THETA] = 0.0
    ...
    def sample_unsafe(
        ...
        for obst_index in range(self.n_obstacles):
            ...
            x_unsafe[obst_i_indices, AdaptivePusherSliderStickingForceInput3.S_X] = \
                torch.cos(x_abst_unsafe[obst_i_indices, ABSTRACT_THETA]) * r_i + \
                s_unsafe[obst_i_indices, obst_center_x_index]

            x_unsafe[obst_i_indices, AdaptivePusherSliderStickingForceInput3.S_Y] = \
                torch.sin(x_abst_unsafe[obst_i_indices, ABSTRACT_THETA]) * r_i + \
                s_unsafe[obst_i_indices, obst_center_y_index]

            x_unsafe[obst_i_indices, AdaptivePusherSliderStickingForceInput3.S_THETA] = \
    ...
    def sample_goal(
        ...
        x_goal[:, AdaptivePusherSliderStickingForceInput3.S_X] = \
            torch.cos(x_abst_goal[:, ABSTRACT_THETA]) * r_i + \
            s_goal[:, goal_x_index]

        x_goal[:, AdaptivePusherSliderStickingForceInput3.S_Y] = \
            torch.sin(x_abst_goal[:, ABSTRACT_THETA]) * r_i + \
            s_goal[:, goal_y_index]

        x_goal[:, AdaptivePusherSliderStickingForceInput3.S_THETA] = \
    ...
    def _g(self, x: torch.Tensor, s_vec: torch.Tensor) -> torch.Tensor:
        ...
        # States
        s_x = x[:, AdaptivePusherSliderStickingForceInput3.S_X]
        s_y = x[:, AdaptivePusherSliderStickingForceInput3.S_Y]
        s_theta = x[:, AdaptivePusherSliderStickingForceInput3.S_THETA]

        # Algorithm
        g[:, AdaptivePusherSliderStickingForceInput3.S_X, AdaptivePusherSliderStickingForceInput3.F_X] = torch.cos(s_theta) * a
        g[:, AdaptivePusherSliderStickingForceInput3.S_X, AdaptivePusherSliderStickingForceInput3.F_Y] = -torch.sin(s_theta) * a

        g[:, AdaptivePusherSliderStickingForceInput3.S_Y, AdaptivePusherSliderStickingForceInput3.F_X] = torch.sin(s_theta) * a
        g[:, AdaptivePusherSliderStickingForceInput3.S_Y, AdaptivePusherSliderStickingForceInput3.F_Y] = torch.cos(s_theta) * a
    ...
    def _G(self, x: torch.Tensor, s_vec: torch.Tensor) -> torch.Tensor:
        ...
        G[:, AdaptivePusherSliderStickingForceInput3.S_THETA, AdaptivePusherSliderStickingForceInput3.F_X, AdaptivePusherSliderStickingForceInput3.C_Y] = -b
        G[:, AdaptivePusherSliderStickingForceInput3.S_THETA, AdaptivePusherSliderStickingForceInput3.F_Y, AdaptivePusherSliderStickingForceInput3.C_X] = b
    ...
    def u_nominal(
        ...
        s_x = x[:, AdaptivePusherSliderStickingForceInput3.S_X]
        s_y = x[:, AdaptivePusherSliderStickingForceInput3.S_Y]
        s_th = x[:, AdaptivePusherSliderStickingForceInput3.S_THETA]
        ...
        u_nominal = torch.zeros((batch_size, AdaptivePusherSliderStickingForceInput3.N_CONTROLS)).to(self.device)
        ...
        u_nominal[des_angle_in_fc_mask, AdaptivePusherSliderStickingForceInput3.F_X] = \
            torch.cos(des_angle[des_angle_in_fc_mask])
        u_nominal[des_angle_in_fc_mask, AdaptivePusherSliderStickingForceInput3.F_Y] = \
