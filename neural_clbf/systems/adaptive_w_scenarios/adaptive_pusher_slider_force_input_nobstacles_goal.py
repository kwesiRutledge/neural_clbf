...
from neural_clbf.systems.adaptive_w_scenarios import (
    ControlAffineParameterAffineSystem2,
)
...
class AdaptivePusherSliderStickingForceInput_NObstacles(ControlAffineParameterAffineSystem2):
    """
    ...
    def __init__(
        ...
        assert self.P_scenario.dim == self.n_scenario, f"P_scenario has dimension {P_scenario.dim}; expected dimension {self.n_scenario}"
    ...
    @property
    def n_dims(self) -> int:
        return AdaptivePusherSliderStickingForceInput_NObstacles.N_DIMS

    @property
    def angle_dims(self) -> List[int]:
        return [AdaptivePusherSliderStickingForceInput_NObstacles.S_THETA]
    ...
    def n_controls(self) -> int:
        return AdaptivePusherSliderStickingForceInput_NObstacles.N_CONTROLS

    @property
    def n_params(self) -> int:
        return AdaptivePusherSliderStickingForceInput_NObstacles.N_PARAMETERS
    ...
    def state_limits(self) -> Tuple[torch.Tensor, torch.Tensor]:
        ...
        upper_limit[AdaptivePusherSliderStickingForceInput_NObstacles.S_X] = 1.0
        upper_limit[AdaptivePusherSliderStickingForceInput_NObstacles.S_Y] = 1.0
        upper_limit[AdaptivePusherSliderStickingForceInput_NObstacles.S_THETA] = torch.pi
    ...
    def goal_point(self, theta: torch.Tensor, s_vec: torch.Tensor) -> torch.Tensor:
        ...
        goal[:, AdaptivePusherSliderStickingForceInput_NObstacles.S_X] = s_vec[:, AdaptivePusherSliderStickingForceInput_NObstacles.GOAL_X]
        goal[:, AdaptivePusherSliderStickingForceInput_NObstacles.S_Y] = s_vec[:, AdaptivePusherSliderStickingForceInput_NObstacles.GOAL_Y]
        goal[:, AdaptivePusherSliderStickingForceInput_NObstacles.S_THETA] = 0.0
    ...
    def _g(self, x: torch.Tensor, s_vec: torch.Tensor) -> torch.Tensor:
        ...
        # States
        s_x = x[:, AdaptivePusherSliderStickingForceInput_NObstacles.S_X]
        s_y = x[:, AdaptivePusherSliderStickingForceInput_NObstacles.S_Y]
        s_theta = x[:, AdaptivePusherSliderStickingForceInput_NObstacles.S_THETA]

        # Algorithm
        g[:, AdaptivePusherSliderStickingForceInput_NObstacles.S_X, AdaptivePusherSliderStickingForceInput_NObstacles.F_X] = torch.cos(s_theta) * a
        g[:, AdaptivePusherSliderStickingForceInput_NObstacles.S_X, AdaptivePusherSliderStickingForceInput_NObstacles.F_Y] = -torch.sin(s_theta) * a

        g[:, AdaptivePusherSliderStickingForceInput_NObstacles.S_Y, AdaptivePusherSliderStickingForceInput_NObstacles.F_X] = torch.sin(s_theta) * a
        g[:, AdaptivePusherSliderStickingForceInput_NObstacles.S_Y, AdaptivePusherSliderStickingForceInput_NObstacles.F_Y] = torch.cos(s_theta) * a
    ...
    def _G(self, x: torch.Tensor, s_vec: torch.Tensor) -> torch.Tensor:
        ...
        G[:, AdaptivePusherSliderStickingForceInput_NObstacles.S_THETA, AdaptivePusherSliderStickingForceInput_NObstacles.F_X, AdaptivePusherSliderStickingForceInput_NObstacles.C_Y] = -b
        G[:, AdaptivePusherSliderStickingForceInput_NObstacles.S_THETA, AdaptivePusherSliderStickingForceInput_NObstacles.F_Y, AdaptivePusherSliderStickingForceInput_NObstacles.C_X] = b
    ...
    def u_nominal(
        ...
        s_x = x[:, AdaptivePusherSliderStickingForceInput_NObstacles.S_X]
        s_y = x[:, AdaptivePusherSliderStickingForceInput_NObstacles.S_Y]
        s_th = x[:, AdaptivePusherSliderStickingForceInput_NObstacles.S_THETA]
        ...
        u_nominal = torch.zeros((batch_size, AdaptivePusherSliderStickingForceInput_NObstacles.N_CONTROLS)).to(self.device)
        ...
        u_nominal[des_angle_in_fc_mask, AdaptivePusherSliderStickingForceInput_NObstacles.F_X] = \
            torch.cos(des_angle[des_angle_in_fc_mask])
        u_nominal[des_angle_in_fc_mask, AdaptivePusherSliderStickingForceInput_NObstacles.F_Y] = \
