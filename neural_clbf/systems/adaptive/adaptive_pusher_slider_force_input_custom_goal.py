...
class AdaptivePusherSliderStickingForceInput_CustomGoal(ControlAffineParameterAffineSystem):
    """
    ...
    @property
    def n_dims(self) -> int:
        return AdaptivePusherSliderStickingForceInput_CustomGoal.N_DIMS

    @property
    def angle_dims(self) -> List[int]:
        return [AdaptivePusherSliderStickingForceInput_CustomGoal.S_THETA]
    ...
    def n_controls(self) -> int:
        return AdaptivePusherSliderStickingForceInput_CustomGoal.N_CONTROLS

    @property
    def n_params(self) -> int:
        return AdaptivePusherSliderStickingForceInput_CustomGoal.N_PARAMETERS
    ...
    def state_limits(self) -> Tuple[torch.Tensor, torch.Tensor]:
        ...
        upper_limit[AdaptivePusherSliderStickingForceInput_CustomGoal.S_X] = 1.0
        upper_limit[AdaptivePusherSliderStickingForceInput_CustomGoal.S_Y] = 1.0
        upper_limit[AdaptivePusherSliderStickingForceInput_CustomGoal.S_THETA] = torch.pi
    ...
    def goal_point(self, theta: torch.Tensor) -> torch.Tensor:
        ...
        goal[:, AdaptivePusherSliderStickingForceInput_CustomGoal.S_X] = theta[:, AdaptivePusherSliderStickingForceInput_CustomGoal.G_X]
        goal[:, AdaptivePusherSliderStickingForceInput_CustomGoal.S_Y] = theta[:, AdaptivePusherSliderStickingForceInput_CustomGoal.G_Y]
        goal[:, AdaptivePusherSliderStickingForceInput_CustomGoal.S_THETA] = 0.0
    ...
    def _g(self, x: torch.Tensor, params: Scenario) -> torch.Tensor:
        ...
        # States
        s_x = x[:, AdaptivePusherSliderStickingForceInput_CustomGoal.S_X]
        s_y = x[:, AdaptivePusherSliderStickingForceInput_CustomGoal.S_Y]
        s_theta = x[:, AdaptivePusherSliderStickingForceInput_CustomGoal.S_THETA]

        # Algorithm
        g[:, AdaptivePusherSliderStickingForceInput_CustomGoal.S_X, AdaptivePusherSliderStickingForceInput_CustomGoal.F_X] = torch.cos(s_theta) * a
        g[:, AdaptivePusherSliderStickingForceInput_CustomGoal.S_X, AdaptivePusherSliderStickingForceInput_CustomGoal.F_Y] = -torch.sin(s_theta) * a

        g[:, AdaptivePusherSliderStickingForceInput_CustomGoal.S_Y, AdaptivePusherSliderStickingForceInput_CustomGoal.F_X] = torch.sin(s_theta) * a
        g[:, AdaptivePusherSliderStickingForceInput_CustomGoal.S_Y, AdaptivePusherSliderStickingForceInput_CustomGoal.F_Y] = torch.cos(s_theta) * a
    ...
    def _G(self, x: torch.Tensor, params: Scenario) -> torch.Tensor:
        ...
        G[:, AdaptivePusherSliderStickingForceInput_CustomGoal.S_THETA, AdaptivePusherSliderStickingForceInput_CustomGoal.F_X, AdaptivePusherSliderStickingForceInput_CustomGoal.C_Y] = -b
        G[:, AdaptivePusherSliderStickingForceInput_CustomGoal.S_THETA, AdaptivePusherSliderStickingForceInput_CustomGoal.F_Y, AdaptivePusherSliderStickingForceInput_CustomGoal.C_X] = b
    ...
    def u_nominal(
        ...
        s_x = x[:, AdaptivePusherSliderStickingForceInput_CustomGoal.S_X]
        s_y = x[:, AdaptivePusherSliderStickingForceInput_CustomGoal.S_Y]
        s_th = x[:, AdaptivePusherSliderStickingForceInput_CustomGoal.S_THETA]
        ...
        u_nominal = torch.zeros((batch_size, AdaptivePusherSliderStickingForceInput_CustomGoal.N_CONTROLS)).to(self.device)
        ...
        u_nominal[des_angle_in_fc_mask, AdaptivePusherSliderStickingForceInput_CustomGoal.F_X] = \
            torch.cos(des_angle[des_angle_in_fc_mask])
        u_nominal[des_angle_in_fc_mask, AdaptivePusherSliderStickingForceInput_CustomGoal.F_Y] = \
