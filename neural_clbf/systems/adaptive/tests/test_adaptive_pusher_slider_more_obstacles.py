...
from neural_clbf.systems.adaptive import AdaptivePusherSliderStickingForceInput_MoreObstacles
...
class TestStringMethods(unittest.TestCase):
    ...
    #         ])
    #     )
    #     ps = AdaptivePusherSliderStickingForceInput_MoreObstacles(
    #         nominal_scenario,
    #         Theta1,
    #     )
    #
    ...
    def test_plot7(self):
        ...
        # Constants
        nominal_scenario = {
            "obstacle_centers":[ (0.0, 0.0), (0.3, 0.0)],
            "obstacle_radii": [0.05, 0.05],
        }
        s_length = 0.09
        s_width = 0.09
        Theta1 = pc.box2poly(
        ...
        if "/neural_clbf/systems/adaptive/tests" in os.getcwd():
            # Only save if we are running from inside tests directory
            p6.savefig("figures/pusherslider-multobjects-test_plot7.png", dpi=300)
